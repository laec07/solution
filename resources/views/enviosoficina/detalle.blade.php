...
<div class="card">
			...
			<div class="col">
				...
				<b> Mensajero:</b>
					@foreach($mensajeros as $mensajero)
						@if($result->user_id == $mensajero->id)
						{{$mensajero->name}}
						@endif
					@endforeach
				</p>
	...
	<form action="{{route('enviosoficina.update', $result->no_envio)}}" method="POST">
		@method('PATCH')
		@csrf
	
		<button type="submit" class="btn btn-primary btn-block">Guardar</button>
	</form>
		<a href="{{url('enviosoficina')}}" class="btn btn-secondary btn-block">Cancelar</a>
	</div>
</div>
@endforeach
